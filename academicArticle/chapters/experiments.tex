...
\begin{figure}[!t]
	...
	\caption{(a) compares the mean CPU usage value (\%) in relationship to the number of active concurrent connections. (b) compares the development of the coefficient of variation $C_v$ depending on the number of concurrent connections being handled by the two different programs.}
	\label{fig_results}
\end{figure}
